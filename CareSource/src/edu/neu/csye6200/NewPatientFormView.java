        ...
        if (e.getSource() == check) {
            ...
            if (term.isSelected()) {
            	...
            	if (statusName == true && statusIns == true) {
	        		...
	        		int check1 = diff_term.getMonths();
	        		check1 = check1+checkYear;
	        		System.out.println("Months:"+check1);
...
//			                res.setText("Please provide input to all the fields..");	                
			                ...
			                if(n > -1) {
			                	...
			                	ActionListener a1 = new ActionListener() {
									...
									public void actionPerformed(ActionEvent f) {
										if(f.getSource() == sub) {
						                	...
						                	String temp_new_pat = pfd.patient(tname.getText(), tmno.getText(), patientWard, n);
						                	System.out.println(tname.getText()+tmno.getText()+patientWard+n);
						                	setVisible(false);
						                	new DoctorAssignment(temp_new_pat);
			                	...
			                	tout.setText(data2+"Bed Not Available...");
			                }
